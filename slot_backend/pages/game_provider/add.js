...
export default class AddGame extends React.Component {
    ...
    async AddGame() {
        ...
        const a = {
            game_code: this.state.game_code, game_name: this.state.game_name, game_brand: 'QTECH',
            game_img: this.state.game_img, game_new: game_new,
            game_status: game_status, game_img_app: this.state.game_img_app
        };
        console.log('Add Game Provider start...');
        await ServiceGameProvider.createGames(a).then((res)=> {
            console.log('res : ' + res.data);
            if (res.data.status === 2000) {
                console.log('Add Game Provider Success!!!');
                this.dialog.show({
    ...
    render() {
        ...
        return <AdminLayoutHoc contentTitle={'Add Game Provider'} contentTitleButton={<i className="fa fa-2x fa-cubes" />} url={this.props.url}>
