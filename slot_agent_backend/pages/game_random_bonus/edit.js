...
import { ServiceAgent, ServiceUserAgent, ServiceUser, ServiceNews, ServiceGameBonus, ServiceImage } from "../../service";
...
export default class EditNews extends React.Component {
    ...
    async EditTopupGame() {
        ...
        console.log('Edit Topup Game start...');
        const res2 = await ServiceGameBonus.editGamesBonus(a, this.state.bonusId);
        console.log('res : ' + res2.data);
        if (res2.data.status === 2000) {
            console.log('Edit Topup Game Success!!!');
            this.dialog.show({
    ...
    componentDidMount() {
        ...
        ServiceGameBonus.getGamesBonusFromId(this.state.bonusId).then((res) => {
            ...
            if (status === 2000) {
                ...
                const { bonus_name, bonus_img1, bonus_img2, bonus_img3, bonus_img4, bonus_img5, bonus_img6, bonus_img7,
                    bonus_value1,bonus_value2,bonus_value3,bonus_value4,bonus_value5,bonus_value6, bonus_value7,
                    member_point, bonus_status } = data[0];
                if (bonus_img1 !== '') {
                    this.setState({ imagePreviewUrl1: ServiceImage.imageshow(bonus_img1), bonus_img1: bonus_img1 });
                } else {
                    this.setState({ imagePreviewUrl1: ServiceImage.imageshow("1594692624651-no-image-available.png") });
                }
                if (bonus_img2 !== '') {
                    this.setState({ imagePreviewUrl2: ServiceImage.imageshow(bonus_img2), bonus_img2: bonus_img2 });
                } else {
                    this.setState({ imagePreviewUrl2: ServiceImage.imageshow("1594692624651-no-image-available.png") });
                }
                if (bonus_img3 !== '') {
                    this.setState({ imagePreviewUrl3: ServiceImage.imageshow(bonus_img3), bonus_img3: bonus_img3 });
                } else {
                    this.setState({ imagePreviewUrl3: ServiceImage.imageshow("1594692624651-no-image-available.png") });
                }
                if (bonus_img4 !== '') {
                    this.setState({ imagePreviewUrl4: ServiceImage.imageshow(bonus_img4), bonus_img4: bonus_img4 });
                } else {
                    this.setState({ imagePreviewUrl4: ServiceImage.imageshow("1594692624651-no-image-available.png") });
                }
                if (bonus_img5 !== '') {
                    this.setState({ imagePreviewUrl5: ServiceImage.imageshow(bonus_img5), bonus_img5: bonus_img5 });
                } else {
                    this.setState({ imagePreviewUrl5: ServiceImage.imageshow("1594692624651-no-image-available.png") });
                }
                if (bonus_img6 !== '') {
                    this.setState({ imagePreviewUrl6: ServiceImage.imageshow(bonus_img6), bonus_img6: bonus_img6 });
                } else {
                    this.setState({ imagePreviewUrl6: ServiceImage.imageshow("1594692624651-no-image-available.png") });
                }
                if (bonus_img7 !== '') {
                    this.setState({ imagePreviewUrl7: ServiceImage.imageshow(bonus_img7), bonus_img7: bonus_img7 });
                } else {
                    this.setState({ imagePreviewUrl7: ServiceImage.imageshow("1594692624651-no-image-available.png") });
                }

                this.setState({
                    bonus_name: bonus_name, member_point: member_point,
                    bonus_value1: bonus_value1,
                    bonus_value2: bonus_value2,
                    bonus_value3: bonus_value3,
                    bonus_value4: bonus_value4,
                    bonus_value5: bonus_value5,
                    bonus_value6: bonus_value6,
                    bonus_value7: bonus_value7,
                    switch1: Boolean(Number(bonus_status))
                });
            } else {
    ...
    render() {
        ...
        return <AdminLayoutHoc contentTitle={'Edit Topup Game'} contentTitleButton={<i className="fa fa-2x fa-gamepad" />} url={this.props.url}>
