...
import { ServiceGameBonus } from "../../service";
//
...
export default class Index extends React.Component {
    ...
    onSearchClick() {
        ...
        if (name != "") {
            this.setState({
                data: this.state.rawdata.filter((mynews) => {
                    return mynews.news_text.indexOf(name) !== -1;
                })
            });
            datalength = this.state.rawdata.filter((mynews) => {
                return mynews.news_text.indexOf(name) !== -1;
            }).length;
        } else {
            this.setState({
    ...
    componentDidMount() {
        ...
        ServiceGameBonus.listGamesBonus(Cookies.get("agentcode")).then((res) => {
            console.log(res.data);
            const { data, status } = res.data;
            if (status === 2000) {
                console.log("data length : " + data.length);
    ...
    render() {
        return <AdminLayoutHoc
            contentTitle={'Game Bonus Topup'}
            contentTitleButton={<Link href="/game_random_bonus/add">
                <button type="button" className="btn btn-outline-success btn-sm"><i className=" fa fa-gamepad" /> Add a new Game</button>
            </Link>}
            url={this.props.url}
        >
            <div className="row">
                            ...
                            <table className="table table-hover table-striped table-bordered">
                                <thead  class="table-dark">
                                    <tr >
                                        ...
                                        <th style={{ width: '12%' }}>Image1</th>
                                        <th style={{ width: '12%' }}>Image2</th>
                                        <th style={{ width: '12%' }}>Image3</th>
                                        <th style={{ width: '12%' }}>Image4</th>
                                        <th style={{ width: '12%' }}>Image5</th>
                                        <th style={{ width: '12%' }}>Image6</th>
                                        <th style={{ width: '12%' }}>Image7</th>
                                        ...
                                        if (index >= this.state.startrow && index < this.state.endrow)
                                            ...
                                            return (
                                                <tr key={index}>
                                                    ...
                                                    <td className="py-1">
                                                        <img
                                                            src={bonus.bonus_img1 ? ServiceImage.imageshow(bonus.bonus_img1) : ServiceImage.imageshow("1594692624651-no-image-available.png")}
                                                            style={{
                                                                flex: 1,
                                                                height: "50px",
                                                                width: null,
                                                    ...
                                                    <td className="py-1">
                                                        <img
                                                            src={bonus.bonus_img2 ? ServiceImage.imageshow(bonus.bonus_img2) : ServiceImage.imageshow("1594692624651-no-image-available.png")}
                                                            style={{
                                                                flex: 1,
                                                                height: "50px",
                                                                width: null,
                                                    ...
                                                    <td className="py-1">
                                                        <img
                                                            src={bonus.bonus_img3 ? ServiceImage.imageshow(bonus.bonus_img3) : ServiceImage.imageshow("1594692624651-no-image-available.png")}
                                                            style={{
                                                                flex: 1,
                                                                height: "50px",
                                                                width: null,
                                                    ...
                                                    <td className="py-1">
                                                        <img
                                                            src={bonus.bonus_img4 ? ServiceImage.imageshow(bonus.bonus_img4) : ServiceImage.imageshow("1594692624651-no-image-available.png")}
                                                            style={{
                                                                flex: 1,
                                                                height: "50px",
                                                                width: null,
                                                    ...
                                                    <td className="py-1">
                                                        <img
                                                            src={bonus.bonus_img5 ? ServiceImage.imageshow(bonus.bonus_img5) : ServiceImage.imageshow("1594692624651-no-image-available.png")}
                                                            style={{
                                                                flex: 1,
                                                                height: "50px",
                                                                width: null,
                                                    ...
                                                    <td className="py-1">
                                                        <img
                                                            src={bonus.bonus_img6 ? ServiceImage.imageshow(bonus.bonus_img6) : ServiceImage.imageshow("1594692624651-no-image-available.png")}
                                                            style={{
                                                                flex: 1,
                                                                height: "50px",
                                                                width: null,
                                                    ...
                                                    <td className="py-1">
                                                        <img
                                                            src={bonus.bonus_img7 ? ServiceImage.imageshow(bonus.bonus_img7) : ServiceImage.imageshow("1594692624651-no-image-available.png")}
                                                            style={{
                                                                flex: 1,
                                                                height: "50px",
                                                                width: null,
                                                    ...
                                                    <td className="py-1" style={{ textAlign: "center" }}>
                                                        <button
                                                            ...
                                                            onClick={() => {
                                                                console.log("edit bonus id " + bonus._id);
                                                                Cookies.set("bonusId", bonus._id);
                                                                //Cookies.set("uagentid", uagent.agent_code);
                                                                Router.push("/game_random_bonus/edit");
