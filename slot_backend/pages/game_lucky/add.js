...
export default class AddBrand extends React.Component {
    ...
    async AddBrand() {
        ...
        const a = {
            ...
            brand_status: brand_status, play_url: this.state.play_url
        };
    ...
    render() {
        ...
        return <AdminLayoutHoc contentTitle={'Add Brand'} contentTitleButton={<i className="fa fa-2x fa-cubes" />} url={this.props.url}>
                ...
                <div className="card mt-2">
                    <form className="form-horizontal">
                        <div className="card-body">
                            ...
                            <div className="input-group mb-3 input-group-sm">
                                <div className="input-group-prepend col-3">
                                    <span className="input-group-text bg-dark col-12">brand name</span>
                                </div>
                            ...
                            <div className="input-group mb-3 input-group-sm">
                                <div className="input-group-prepend col-3">
                                    <span className="input-group-text bg-dark col-12">brand api key</span>
                                </div>
                            ...
                            <div className="input-group mb-3 input-group-sm">
                                <div className="input-group-prepend col-3">
                                    <span className="input-group-text bg-dark col-12">play url</span>
                                </div>
