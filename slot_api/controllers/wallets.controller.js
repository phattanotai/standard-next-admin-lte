...
module.exports.getWalletsById = async (req, res) => {
    try{
...
module.exports.getWalletsByAgent = async (req, res) => {
    try{
...
module.exports.createWallets = async (req, res) => {
    try{
...
module.exports.updateWallets = async (req, res) => {
    try{
...
module.exports.deleteWallets = async (req, res) => {
    try{
