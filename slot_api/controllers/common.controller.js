...
module.exports.backend = (req, res) => {
    try{
...
module.exports.checkMemberToken = (req, res) => {
    try{
...
module.exports.agentLogin = (req, res) => {
    try{
        console.log('body::==', req.body);
        console.log('params::==', req.params);
        const { username, password } = req.body;
...
module.exports.memberLogin = (req, res) => {
    try{
        console.log('body::==', req.body);
        console.log('params::==', req.params);
        const { username, password } = req.body;
...
module.exports.memberLogin1 = (req, res) => {
    try{
        console.log('body::==', req.body);
        console.log('params::==', req.params);
        const { username, password } = req.body;
...
module.exports.memberLogin2 = (req, res) => {
    try{
        console.log('body::==', req.body);
        console.log('params::==', req.params);
        const { username, password } = req.body;
...
module.exports.memberLogoffByid = (req, res) => {
    try{
...
module.exports.getGamelistByAgent = (req, res) => {
    try{
...
module.exports.loadAllGameByAgant = (req, res) => {
    try{
    apilog('Get game list from agent code');
    apilog('params::==', req.params);
    const agent_code = req.params.agent_code
...
module.exports.loadGameByAgant = (req, res) => {
    try{
        apilog('Get game list from agent code');
        apilog('params::==', req.params);
        const agent_code = req.params.agent_code
...
module.exports.getBrandListByAgent = (req, res) => {
    try{
