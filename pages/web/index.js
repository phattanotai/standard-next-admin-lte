...
export default class Web extends React.Component {
    ...
    async deleteWeb(id) {
        ...
        try {
            const res = await ServiceWeb.deleteWeb(id);
    ...
    render() {
        return <AdminLayoutHoc
            contentTitle={'Webs'}
            contentTitleButton={<Link href="/web/create">
                <button type="button" className="btn btn-outline-success btn-sm"><i className="fa fa-globe fa-fw" /> Add a new web</button>
            </Link>}
            url={this.props.url}
        >
            <div className="row">
