...
export default class UserAgent extends React.Component {
    ...
    render() {
        return <AdminLayoutHoc
            contentTitle={'UserAgent'}
            contentTitleButton={<Link href="/useragent/create">
                <button type="button" className="btn btn-outline-success btn-sm"><i className="fa fa-server fa-fw" /> Add a new UserAgent</button>
            </Link>}
            url={this.props.url}
        >
            <div className="row">
                                                ...
                                                <tr key={index}>
                                                    ...
                                                    <td className="py-1" style={{ textAlign: "right" }}>
                                                        <button
                                                            ...
                                                            onClick={() => {
                                                                console.log("edit UserAgent id:" + data.postId);
                                                                Cookies.set("useragentid", data.postId);
                                                                Router.push("/useragent/edit");
                                                            }}
                                                            ...
                                                            onClick={() => {
                                                                this.dialog.show({
                                                                    ...
                                                                    actions: [
                                                                        ...
                                                                        Dialog.OKAction(() => {
                                                                            console.log("delete userAgent id:" + data.postId);
                                                                            this.deleteUserAgent(data.postId);
                                                                        })
                                                                    ],
                                                                    bsSize: 'small',
                                                                    onHide: (dialog) => {
